...
class CollectionRCItem extends React.Component {
    ...
    menuItems = [
        ...
        { name: 'manage_roles', disabled: true, label: 'Manage Roles', icon: () => getByTheme(MANAGE_ROLES_ICON, DARK_THEME_MANAGE_ROLES_ICON), },
        ...
        { name: 'create_fork', disabled: true, label: 'Create a fork', icon: () => getByTheme(CREATE_FORK_ICON, DARK_THEME_CREATE_FORK_ICON), },
        { name: 'merge_changes', disabled: true, label: 'Merge changes', icon: () => getByTheme(MERGE_CHANGES_ICON, DARK_THEME_MERGE_CHANGES_ICON), },
        ...
        { name: 'monitor_collection', disabled: true, label: 'Monitor Collection', icon: () => getByTheme(MONITOR_COLLECTION_ICON, DARK_THEME_MONITOR_COLLECTION_ICON), },
        { name: 'mock_collection', disabled: true, label: 'Mock Collection', icon: () => getByTheme(MOCK_COLLECTION, DARK_THEME_MOCK_COLLECTION), },
        { name: 'publish_docs', disabled: true, label: 'Publish Docs', icon: () => getByTheme(PUBLISH_DOCS_ICON, DARK_THEME_PUBLISH_DOCS_ICON), },
